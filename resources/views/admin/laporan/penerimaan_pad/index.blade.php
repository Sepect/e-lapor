...
@section('title', 'Laporan Penerimaan PAD')
@section('subtitle', 'Laporan Penerimaan PAD')
...
@section('content')
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
        <div class="card-body p-4 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 bg-white position-relative">
            ...
            <div class="flex-grow-1 z-1">
                <h5 class="fw-bold mb-1 text-dark">Laporan Penerimaan PAD</h5>
                <p class="text-muted mb-0 small">Cetak laporan penerimaan Pendapatan Asli Daerah dari tagihan yang telah lunas.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white border-bottom p-4 d-flex align-items-center">
            ...
            <div>
                <h6 class="mb-0 fw-bold text-dark">Cetak Penerimaan PAD</h6>
        ...
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('admin.laporan.cetak') }}" method="POST">
                @csrf
                <input type="hidden" name="jenis_laporan" value="penerimaan_pad">

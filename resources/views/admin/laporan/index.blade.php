...
@section('title', 'Laporan Keseluruhan/Lengkap')
@section('subtitle', 'Laporan Keseluruhan/Lengkap')
...
@section('content')
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
        <div class="card-body p-4 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 bg-white position-relative">
            ...
            <div class="flex-grow-1 z-1">
                <h5 class="fw-bold mb-1 text-dark">Laporan Pengelolaan Limbah B3</h5>
                <p class="text-muted mb-0 small">Cetak laporan lengkap pengelolaan limbah B3 berdasarkan periode dan tahun.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white border-bottom p-4 d-flex align-items-center">
            ...
            <div>
                <h6 class="mb-0 fw-bold text-dark">Cetak Laporan Lengkap</h6>
        ...
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('admin.laporan.cetak') }}" method="POST">
                @csrf
                <input type="hidden" name="jenis_laporan" value="lengkap">
